% airfoilAnalytic9090UnitTest test functions and library of simple fuselage
%
...
%
% Example call:
%   rt = table(runtests('airfoilAnalytic9090UnitTest'))
%
% Literature: 
...
function tests = airfoilAnalytic9090UnitTest
    tests = functiontests(localfunctions);
end


function airfoilAnalytic9090ExampleScriptTest(testCase)

run('airfoilAnalytic9090_example');
close all;
