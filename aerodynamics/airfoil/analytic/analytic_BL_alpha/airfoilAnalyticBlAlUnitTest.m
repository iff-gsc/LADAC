% airfoilAnalyticBlAlUnitTest test functions and library of simple fuselage
%
...
%
% Example call:
%   rt = table(runtests('airfoilAnalyticBlAlUnitTest'))
%
% Literature: 
...
function tests = airfoilAnalyticBlAlUnitTest
    tests = functiontests(localfunctions);
end


function airfoilAnalyticBlAlExampleScriptTest(testCase)

run('airfoilAnalyticBlAl_example');
close all;
