% airfoilAnalyticSimpleUnitTest test functions and library of simple fuselage
%
...
%
% Example call:
%   rt = table(runtests('airfoilAnalyticSimpleUnitTest'))
%
% Literature: 
...
function tests = airfoilAnalyticSimpleUnitTest
    tests = functiontests(localfunctions);
end


function airfoilAnalyticSimpleExampleScriptTest(testCase)

run('airfoilAnalyticSimple_example');
close all;
