...
%   delta               actuator setting (Nx1 array), in arbitrary unit
%   Delta_c_L           delta lift coefficient due to actuator setting (Nx1
%                       array), dimensionless
%   Delta_c_D           delta drag coefficient due to actuator setting (Nx1
%                       array), dimensionless
%   Delta_c_m           delta pitching moment coefficient due to actuator 
%                       setting (Nx1 array), dimensionless
%   vis_flag            flag if analytic fit should be visualized (scalar
%                       bolean)
% 
% Outputs:
%   fdcl                solution for the analtic function coefficients for
%                       the delta lift coefficient (1x3 array)
...
optsDe = fitoptions( 'Method', 'NonlinearLeastSquares' );
optsDe.Display = 'Off';
