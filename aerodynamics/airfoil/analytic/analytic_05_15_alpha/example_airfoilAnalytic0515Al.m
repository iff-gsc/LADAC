...
fclv = zeros(length(F15_bl.Mach.data),6);
fcdv = zeros(length(F15_bl.Mach.data),6);
fcmv = zeros(length(F15_bl.Mach.data),5);
fdclv = zeros(length(F15_bl.Mach.data),3);
fdcdv = zeros(length(F15_bl.Mach.data),3);
fdcmv = zeros(length(F15_bl.Mach.data),3);
...
fclmax = max(abs(fclvq));
fcdmax = max(abs(fcdvq));
fcmmax = max(abs(fcmvq));
fdclmax = max(abs(fdclvq));
fdcdmax = max(abs(fdcdvq));
fdcmmax = max(abs(fdcmvq));
