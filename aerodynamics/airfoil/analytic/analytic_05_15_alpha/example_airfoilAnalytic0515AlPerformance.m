...
tic
for i = 1:1000
    fMa = airfoilAnalytic0515Ma( airfoil_F15.wcl, Ma_vec, 4, 6 );
end
toc
...
tic
for i = 1:1000
    fMa = airfoilAnalytic0515Ma( airfoil_F15.wcl, alMaDe(:,2), 4, 6 );
    fDe = airfoilAnalytic0515Ma( airfoil_F15.wdcl, alMaDe(:,2), 2, 3 );
