...
if fuselage.config.is_unsteady
    ...
    fuselage.state.aero.unsteady.alpha_dt(:) = 1/T_unsteady * ( alpha - ...
        fuselage.state.aero.unsteady.alpha );
    fuselage.state.aero.unsteady.beta_dt(:) = 1/T_unsteady * ( beta - ...
        fuselage.state.aero.unsteady.beta );
    alB2_dx = diff( fuselage.state.aero.unsteady.alpha .* b2 ) ./ dx;
    beB2_dx = diff( fuselage.state.aero.unsteady.beta .* b2 ) ./ dx;
else
