...
if wing.config.is_infl_recomputed
    wing.interim_results.dimless_induced_vel_beta = ...
        wingGetDimlessIndVel( -wing.state.aero.local_inflow.V_75, wing.state.geometry, wing.config.is_unsteady );
else
