function [ A_red, B_red, C_red, D_red, condA_elim ] = modredEmb( ...
    A, B, C, D, elim, A_red, B_red, C_red, D_red )
%#codegen
...
%   A_red       reduced system matrix (n_red x n_red), required passthrough
%   B_red       reduced input matrix (n_red x p), required passthrough
%   C_red       reduced output matrix (q x n_red), required passthrough
%   D_red       reduced feedthrough matrix (qxp), required passthrough
% 
% Outputs:
