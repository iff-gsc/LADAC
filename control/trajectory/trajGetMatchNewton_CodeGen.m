function [section_idx_ret, error, t_ret] = trajGetMatchNewton_CodeGen(traj, position, active_section)
...
section_idx_ret = ones(1,1,superiorfloat(position));
