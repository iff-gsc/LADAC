...
% 
% Inputs:
%   model           Handle or path to a Simulink model root
% 
% See also:
...
if isempty(base_vars)
   error('MATLAB:apParAddTunability2Model:noModelVariables', ...
         'No supported variables found in the base workspace, please make sure that the model is fully initialized!');
end
